...
static EIF_TYPE_INDEX gen_type8_888 [] = {0xFF11,15,0xFFFF};
static EIF_TYPE_INDEX gen_type9_888 [] = {0xFF11,219,0xFFFF};
static EIF_TYPE_INDEX gen_type10_888 [] = {0xFF11,219,0xFFFF};
static EIF_TYPE_INDEX gen_type11_888 [] = {0xFF11,25,0xFFFF};
static EIF_TYPE_INDEX gen_type12_888 [] = {0xFF11,887,0xFFFF};
static EIF_TYPE_INDEX gen_type13_888 [] = {0xFF11,948,0xFFFF};
static EIF_TYPE_INDEX gen_type14_888 [] = {0xFF11,358,187,0xFFFF};
...
static struct desc_info desc_888[] = {
	...
	{12911, 0, 948, gen_type13_888},
	{12912, (BODY_INDEX)-1, 358, gen_type14_888},
...
void Init888(void)
{
	...
	IDSC(desc_888 + 32, 436, 887);
	IDSC(desc_888 + 34, 448, 887);
	IDSC(desc_888 + 36, 443, 887);
}
