...
extern void F863_6989(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F863_6990(EIF_REFERENCE);
extern EIF_TYPED_VALUE F863_6991(EIF_REFERENCE);
extern void F863_8740(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12620);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(862, Current, 12620);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4915, 0xF80000DB, 0); /* buffer */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(4915, dtype, Dftype(Current))));
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4921, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
...
EIF_TYPED_VALUE F863_6986 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(4916,Dtype(Current)));
	return r;
}
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 862, Current, 0, 1, 12623);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(4916, dtype));
		RTTE(tb1, label_1);
		RTCK;
		RTHOOK(2);
...
void F863_6989 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 862, Current, 2, 1, 12625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(862, Current, 12625);
	RTCC(arg1, 862, l_feature_name, 1, eif_attached_type(217));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if ((EIF_BOOLEAN)(loc2 != (EIF_CHARACTER_8) '\015')) {
			...
			if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 == (EIF_CHARACTER_8) '\012') && (EIF_BOOLEAN) !tb1)) {
				...
				if (tb1) {
					RTHOOK(11);
					uc1 = loc2;
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4917, dtype))(Current, uc1x);
					RTHOOK(12);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !tb2) {
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(4916, dtype));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	if (tb1) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F863_6991 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12627);
	RTSA(Dtype(Current));
	RTSC;
...
void F863_8740 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 862, Current, 0, 8739);
	RTSA(dtype);
	RTME(dtype, 0);
