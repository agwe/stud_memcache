...
static struct desc_info desc_884[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 205, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 205, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type13_884},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 214, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 883, NULL},
};
