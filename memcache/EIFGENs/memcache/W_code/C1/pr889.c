...
extern void F889_7325(EIF_REFERENCE);
extern void F889_7326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F889_7327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7329(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7330(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7331(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7332(EIF_REFERENCE);
extern EIF_TYPED_VALUE F889_7333(EIF_REFERENCE);
extern void F889_8745(EIF_REFERENCE, int);
...
void F889_7325 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 888, Current, 0, 0, 12928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(888, Current, 12928);
	RTIV(Current, RTAL);
...
void F889_7326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 888, Current, 0, 1, 12929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(888, Current, 12929);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("thread_capable", EX_PRE);
...
EIF_TYPED_VALUE F889_7327 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 888, Current, 0, 0, 12930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(888, Current, 12930);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("thread_capable", EX_PRE);
...
body:;
	...
	Result = *(EIF_BOOLEAN *)(Current + RTWA(5245, dtype));
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5246, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5833, "unlock", tr1))(tr1);
...
EIF_TYPED_VALUE F889_7328 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F889_7329 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F889_7330 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F889_7331 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F889_7332 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F889_7333 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F889_8745 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 888, Current, 0, 8744);
	RTSA(dtype);
	RTME(dtype, 0);
